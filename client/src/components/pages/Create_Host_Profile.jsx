      ...
      <div className="container">
        ...
        <form onSubmit={handleSubmit}>
          <div className="form-group"> 
            <label htmlFor="club_name" id="club_name_label">Club Name:</label>
            <input
              type="text"
          ...
          <div className="form-group">
            <label htmlFor="club_email" id="club_email_label">Email:</label>
            <input
              type="email"
              className="form-control"
              id="club_email"
          ...
          <div className="form-group">
            <label htmlFor="club_bio" id="club_bio_label">Bio:</label>
            <textarea
              className="form-control"
              id="club_bio"
              value={bio}
          ...
          <div className="form-group">
            <label htmlFor="profilePhoto" id="photo_label">Club Photo</label>
            <input
              type="file"

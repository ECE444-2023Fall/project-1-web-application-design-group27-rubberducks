...
class Account(db.Model):
    ...
    def __repr__(self):
        return f'<Account {self.uid} {self.name} {self.email} {self.password}>'
    ...
    def update_name(self, name, email, password):
        self.name = name
        self.email = email
...
class Host(db.Model):
    ...
    def update_name(self, name, email, bio, events, owner):
        self.name = name
        self.email = email
        self.bio = bio
        self.events = events
...
class Event(db.Model):
    ...
    def update_name(self, name, location, date, capacity, attendees, owner):
        self.name = name
